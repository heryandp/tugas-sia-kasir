				...
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
						<fieldset>
							...
							<a href="fungsi/edit/edit.php?reset=yes&id=<?php echo $hasil['id_member'];?>" class="btn btn-warning btn-md" onclick="javascript:return confirm('Apakah anda ingin reset password ?');">
            				<i class="fa fa-spinner"></i> Reset Password</a>
