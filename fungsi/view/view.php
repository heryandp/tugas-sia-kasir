...
class view
{
    ...
    {
        $sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, barang.satuan_barang, member.id_member,
    ...
    public function omzet_total(){
        $sql = "SELECT sum(total) total FROM nota";
        $row = $this -> db -> prepare($sql);
        $row -> execute();
        $hasil = $row -> fetch();
        return $hasil;
    ...
    public function omzet_sekarang(){
        $sql = "SELECT sum(total) total FROM nota WHERE periode='".date("m-Y")."'";
        $row = $this -> db -> prepare($sql);
        $row -> execute();
        $hasil = $row -> fetch();
        return $hasil;
